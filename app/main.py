...
precip_sites = ['219910', '320010', '219510']
flow_sites = ['66401']
init_flow_site = '66401'
all_sites = precip_sites + flow_sites
...
def serve_layout():
    ...
    for ds in requested_datasets:
        ...
        sites2 = [s for s in sites1 if s['ref'] in all_sites]

        site_ds.update({ds['dataset_id']: sites2})

    sites3 = [{'label': s['ref'], 'value': s['site_id']} for s in sites2]

    init_flow_site_id = [s['value'] for s in sites3 if s['label'] == init_flow_site][0]
